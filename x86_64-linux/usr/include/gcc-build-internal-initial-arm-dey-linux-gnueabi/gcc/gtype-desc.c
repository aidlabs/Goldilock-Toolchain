...
void
gt_ggc_mx_function_summary_inline_summary__ (void *x_p)
{
  function_summary<inline_summary*> * const x = (function_summary<inline_summary*> *)x_p;
...
void
gt_ggc_mx (struct inline_summary *& x)
{
  if (x)
    gt_ggc_mx_inline_summary ((void *) x);
}
...
gt_ggc_mx (struct ipcp_transformation_summary& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_ggc_m_24vec_ipa_alignment_va_gc_ ((*x).alignments);
}
...
void
gt_ggc_mx_vec_ipa_alignment_va_gc_ (void *x_p)
{
  vec<ipa_alignment,va_gc> * const x = (vec<ipa_alignment,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct ipa_alignment& x_r ATTRIBUTE_UNUSED)
{
  struct ipa_alignment * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_ggc_mx_hash_map_gimple_int_ (void *x_p)
{
...
void
gt_ggc_mx_inline_summary (void *x_p)
{
  struct inline_summary * const x = (struct inline_summary *)x_p;
  if (ggc_test_and_set_mark (x))
    {
...
void
gt_ggc_mx_section_hash_entry_d (void *x_p)
{
  struct section_hash_entry_d * const x = (struct section_hash_entry_d *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_S ((*x).name);
    }
...
void
gt_ggc_mx (struct section_hash_entry_d& x_r ATTRIBUTE_UNUSED)
{
  struct section_hash_entry_d * ATTRIBUTE_UNUSED x = &x_r;
  gt_ggc_m_S ((*x).name);
}

void
gt_ggc_mx (struct section_hash_entry_d *& x)
{
  if (x)
    gt_ggc_mx_section_hash_entry_d ((void *) x);
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_20hash_map_gimple_int_ ((*x).throw_stmt_table);
  ...
  while (x != xlimit)
    {
      switch ((int) (((*x)).type))
        ...
        case SYMTAB_SYMBOL:
          ...
          gt_ggc_m_20section_hash_entry_d ((*x).x_section);
          break;
        case SYMTAB_VARIABLE:
          {
            ...
            gt_ggc_m_20section_hash_entry_d ((*sub).x_section);
          }
          break;
        ...
        case 0:
          switch ((int) (GET_CODE (&(*x))))
            ...
            case SCRATCH:
              break;
            case REG:
              gt_ggc_m_9reg_attrs ((*x).u.fld[1].rt_reg);
              break;
            case PC:
              break;
            case CONST:
    ...
    {
      {
        ...
        if ((*x).info_ordinary.maps != NULL) {
          size_t i0;
          for (i0 = 0; i0 != (size_t)(l0); i0++) {
            switch ((int) (((*x).info_ordinary.maps[i0]).reason == LC_ENTER_MACRO))
              {
              case 0:
      ...
      }
      {
        ...
        if ((*x).info_macro.maps != NULL) {
          ...
          for (i2 = 0; i2 != (size_t)(l2); i2++) {
            switch ((int) (((*x).info_macro.maps[i2]).reason == LC_ENTER_MACRO))
              {
              case 0:
...
void
gt_pch_nx_function_summary_inline_summary__ (void *x_p)
{
  function_summary<inline_summary*> * const x = (function_summary<inline_summary*> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_33function_summary_inline_summary__))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct inline_summary *& x)
{
  if (x)
    gt_pch_nx_inline_summary ((void *) x);
}
...
gt_pch_nx (struct ipcp_transformation_summary& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_pch_n_24vec_ipa_alignment_va_gc_ ((*x).alignments);
}
...
void
gt_pch_nx_vec_ipa_alignment_va_gc_ (void *x_p)
{
  vec<ipa_alignment,va_gc> * const x = (vec<ipa_alignment,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_24vec_ipa_alignment_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct ipa_alignment& x_r ATTRIBUTE_UNUSED)
{
  struct ipa_alignment * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_nx_hash_map_gimple_int_ (void *x_p)
{
  hash_map<gimple,int> * const x = (hash_map<gimple,int> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_20hash_map_gimple_int_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx_inline_summary (void *x_p)
{
  struct inline_summary * const x = (struct inline_summary *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_14inline_summary))
    {
...
void
gt_pch_nx_section_hash_entry_d (void *x_p)
{
  struct section_hash_entry_d * const x = (struct section_hash_entry_d *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_20section_hash_entry_d))
    {
      gt_pch_n_S ((*x).name);
    }
}
...
void
gt_pch_nx (struct section_hash_entry_d& x_r ATTRIBUTE_UNUSED)
{
  struct section_hash_entry_d * ATTRIBUTE_UNUSED x = &x_r;
  gt_pch_n_S ((*x).name);
}
...
void
gt_pch_nx (struct section_hash_entry_d *& x)
{
  if (x)
    gt_pch_nx_section_hash_entry_d ((void *) x);
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9eh_status))
    {
      ...
      gt_pch_n_20hash_map_gimple_int_ ((*x).throw_stmt_table);
  ...
  while (x != xlimit)
    {
      switch ((int) (((*x)).type))
        ...
        case SYMTAB_SYMBOL:
          ...
          gt_pch_n_20section_hash_entry_d ((*x).x_section);
          break;
        case SYMTAB_VARIABLE:
          {
            varpool_node *sub = static_cast <varpool_node *> (x);
            ...
            gt_pch_n_20section_hash_entry_d ((*sub).x_section);
          }
          break;
        case SYMTAB_FUNCTION:
          {
        ...
        case 0:
          switch ((int) (GET_CODE (&(*x))))
            ...
            case SCRATCH:
              break;
            case REG:
              gt_pch_n_9reg_attrs ((*x).u.fld[1].rt_reg);
              break;
            case PC:
              break;
            case CONST:
...
void
gt_pch_p_33function_summary_inline_summary__ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
...
void
gt_pch_p_24vec_ipa_alignment_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<ipa_alignment,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<ipa_alignment,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct ipa_alignment* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
void
gt_pch_p_20hash_map_gimple_int_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
...
void
gt_pch_p_14inline_summary (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct inline_summary * x ATTRIBUTE_UNUSED = (struct inline_summary *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).conds), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).entry), cookie);
...
void
gt_pch_p_20section_hash_entry_d (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct section_hash_entry_d * x ATTRIBUTE_UNUSED = (struct section_hash_entry_d *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).name), cookie);
}

void
gt_pch_nx (struct section_hash_entry_d* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).name), cookie);
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_desc_c[] = {
  ...
  },
  {
    &inline_summaries,
    1,
    sizeof (inline_summaries),
    &gt_ggc_mx_function_summary_inline_summary__,
    &gt_pch_nx_function_summary_inline_summary__
  },
  {
