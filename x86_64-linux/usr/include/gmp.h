...
#define __GMP_CC "gcc "
#define __GMP_CFLAGS "-O2 -pedantic -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -isystem/home/simon/work/goldilocks/tmp/sysroots/x86_64-linux/usr/include -O2 -pipe"
