...
cl_optimization_save (struct cl_optimization *ptr, struct gcc_options *opts)
{
  ...
  gcc_assert (IN_RANGE (opts->x_flag_ipa_cp_alignment, -128, 127));
  ...
  gcc_assert (IN_RANGE (opts->x_flag_loop_unroll_jam, -128, 127));
  ...
  gcc_assert (IN_RANGE (opts->x_flag_strict_overflow, -128, 127));
  ...
  ptr->x_flag_ipa_cp_alignment = opts->x_flag_ipa_cp_alignment;
  ...
  ptr->x_flag_loop_unroll_jam = opts->x_flag_loop_unroll_jam;
  ...
  ptr->x_flag_strict_overflow = opts->x_flag_strict_overflow;
...
cl_optimization_restore (struct gcc_options *opts, struct cl_optimization *ptr)
{
  ...
  opts->x_flag_ipa_cp_alignment = ptr->x_flag_ipa_cp_alignment;
  ...
  opts->x_flag_loop_unroll_jam = ptr->x_flag_loop_unroll_jam;
  ...
  opts->x_flag_strict_overflow = ptr->x_flag_strict_overflow;
                       ...
                       struct cl_optimization *ptr)
{
  ...
  if (ptr->x_flag_ipa_cp_alignment)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_ipa_cp_alignment",
             ptr->x_flag_ipa_cp_alignment);
  ...
  if (ptr->x_flag_loop_unroll_jam)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_loop_unroll_jam",
             ptr->x_flag_loop_unroll_jam);
  ...
  if (ptr->x_flag_strict_overflow)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_strict_overflow",
             ptr->x_flag_strict_overflow);
                            ...
                            struct cl_optimization *ptr2)
{
  ...
  if (ptr1->x_flag_ipa_cp_alignment != ptr2->x_flag_ipa_cp_alignment)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_ipa_cp_alignment",
             ptr1->x_flag_ipa_cp_alignment,
             ptr2->x_flag_ipa_cp_alignment);
  ...
  if (ptr1->x_flag_loop_block != ptr2->x_flag_loop_block)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_loop_block",
             ptr1->x_flag_loop_block,
             ptr2->x_flag_loop_block);
  ...
  if (ptr1->x_flag_loop_optimize_isl != ptr2->x_flag_loop_optimize_isl)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_loop_optimize_isl",
             ptr1->x_flag_loop_optimize_isl,
             ptr2->x_flag_loop_optimize_isl);
  ...
  if (ptr1->x_flag_loop_strip_mine != ptr2->x_flag_loop_strip_mine)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_loop_strip_mine",
             ptr1->x_flag_loop_strip_mine,
             ptr2->x_flag_loop_strip_mine);

  if (ptr1->x_flag_loop_unroll_jam != ptr2->x_flag_loop_unroll_jam)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_loop_unroll_jam",
             ptr1->x_flag_loop_unroll_jam,
             ptr2->x_flag_loop_unroll_jam);
  ...
  if (ptr1->x_flag_short_double != ptr2->x_flag_short_double)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_short_double",
             ptr1->x_flag_short_double,
             ptr2->x_flag_short_double);
  ...
  if (ptr1->x_flag_strict_overflow != ptr2->x_flag_strict_overflow)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_strict_overflow",
             ptr1->x_flag_strict_overflow,
             ptr2->x_flag_strict_overflow);
  ...
  if (ptr1->x_flag_ssa_coalesce_vars != ptr2->x_flag_ssa_coalesce_vars)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_ssa_coalesce_vars",
             ptr1->x_flag_ssa_coalesce_vars,
             ptr2->x_flag_ssa_coalesce_vars);
  ...
  if (ptr1->x_flag_tree_copyrename != ptr2->x_flag_tree_copyrename)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_tree_copyrename",
             ptr1->x_flag_tree_copyrename,
             ptr2->x_flag_tree_copyrename);
  ...
  if (ptr1->x_flag_tree_loop_if_convert_stores != ptr2->x_flag_tree_loop_if_convert_stores)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_tree_loop_if_convert_stores",
             ptr1->x_flag_tree_loop_if_convert_stores,
             ptr2->x_flag_tree_loop_if_convert_stores);
  ...
  if (ptr1->x_flag_unsafe_loop_optimizations != ptr2->x_flag_unsafe_loop_optimizations)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_unsafe_loop_optimizations",
             ptr1->x_flag_unsafe_loop_optimizations,
             ptr2->x_flag_unsafe_loop_optimizations);
...
{
  inchash::hash hstate;
  hstate.add_wide_int (ptr->x_target_flags);
  return hstate.end ();
}
...
{
  inchash::hash hstate;
  hstate.add_wide_int (ptr->x_optimize);
  hstate.add_wide_int (ptr->x_optimize_size);
  hstate.add_wide_int (ptr->x_optimize_debug);
  hstate.add_wide_int (ptr->x_flag_aggressive_loop_optimizations);
  hstate.add_wide_int (ptr->x_align_functions);
  hstate.add_wide_int (ptr->x_align_jumps);
  hstate.add_wide_int (ptr->x_align_labels);
  hstate.add_wide_int (ptr->x_align_loops);
  hstate.add_wide_int (ptr->x_flag_associative_math);
  hstate.add_wide_int (ptr->x_flag_asynchronous_unwind_tables);
  hstate.add_wide_int (ptr->x_flag_auto_inc_dec);
  hstate.add_wide_int (ptr->x_flag_branch_on_count_reg);
  hstate.add_wide_int (ptr->x_flag_branch_probabilities);
  hstate.add_wide_int (ptr->x_flag_branch_target_load_optimize);
  hstate.add_wide_int (ptr->x_flag_branch_target_load_optimize2);
  hstate.add_wide_int (ptr->x_flag_btr_bb_exclusive);
  hstate.add_wide_int (ptr->x_flag_caller_saves);
  hstate.add_wide_int (ptr->x_flag_combine_stack_adjustments);
  hstate.add_wide_int (ptr->x_flag_compare_elim_after_reload);
  hstate.add_wide_int (ptr->x_flag_conserve_stack);
  hstate.add_wide_int (ptr->x_flag_cprop_registers);
  hstate.add_wide_int (ptr->x_flag_crossjumping);
  hstate.add_wide_int (ptr->x_flag_cse_follow_jumps);
  hstate.add_wide_int (ptr->x_flag_cx_fortran_rules);
  hstate.add_wide_int (ptr->x_flag_cx_limited_range);
  hstate.add_wide_int (ptr->x_flag_dce);
  hstate.add_wide_int (ptr->x_flag_defer_pop);
  hstate.add_wide_int (ptr->x_flag_delayed_branch);
  hstate.add_wide_int (ptr->x_flag_delete_dead_exceptions);
  hstate.add_wide_int (ptr->x_flag_delete_null_pointer_checks);
  hstate.add_wide_int (ptr->x_flag_devirtualize);
  hstate.add_wide_int (ptr->x_flag_devirtualize_speculatively);
  hstate.add_wide_int (ptr->x_flag_dse);
  hstate.add_wide_int (ptr->x_flag_early_inlining);
  hstate.add_wide_int (ptr->x_flag_exceptions);
  hstate.add_wide_int (ptr->x_flag_expensive_optimizations);
  hstate.add_wide_int (ptr->x_flag_finite_math_only);
  hstate.add_wide_int (ptr->x_flag_float_store);
  hstate.add_wide_int (ptr->x_flag_forward_propagate);
  hstate.add_wide_int (ptr->x_flag_fp_contract_mode);
  hstate.add_wide_int (ptr->x_flag_no_function_cse);
  hstate.add_wide_int (ptr->x_flag_gcse);
  hstate.add_wide_int (ptr->x_flag_gcse_after_reload);
  hstate.add_wide_int (ptr->x_flag_gcse_las);
  hstate.add_wide_int (ptr->x_flag_gcse_lm);
  hstate.add_wide_int (ptr->x_flag_gcse_sm);
  hstate.add_wide_int (ptr->x_flag_graphite);
  hstate.add_wide_int (ptr->x_flag_graphite_identity);
  hstate.add_wide_int (ptr->x_flag_guess_branch_prob);
  hstate.add_wide_int (ptr->x_flag_hoist_adjacent_loads);
  hstate.add_wide_int (ptr->x_flag_if_conversion);
  hstate.add_wide_int (ptr->x_flag_if_conversion2);
  hstate.add_wide_int (ptr->x_flag_indirect_inlining);
  hstate.add_wide_int (ptr->x_flag_no_inline);
  hstate.add_wide_int (ptr->x_flag_inline_atomics);
  hstate.add_wide_int (ptr->x_flag_inline_functions);
  hstate.add_wide_int (ptr->x_flag_inline_functions_called_once);
  hstate.add_wide_int (ptr->x_flag_inline_small_functions);
  hstate.add_wide_int (ptr->x_flag_ipa_cp);
  hstate.add_wide_int (ptr->x_flag_ipa_cp_alignment);
  hstate.add_wide_int (ptr->x_flag_ipa_cp_clone);
  hstate.add_wide_int (ptr->x_flag_ipa_icf);
  hstate.add_wide_int (ptr->x_flag_ipa_icf_functions);
  hstate.add_wide_int (ptr->x_flag_ipa_profile);
  hstate.add_wide_int (ptr->x_flag_ipa_pta);
  hstate.add_wide_int (ptr->x_flag_ipa_pure_const);
  hstate.add_wide_int (ptr->x_flag_ipa_ra);
  hstate.add_wide_int (ptr->x_flag_ipa_reference);
  hstate.add_wide_int (ptr->x_flag_ipa_sra);
  hstate.add_wide_int (ptr->x_flag_ira_algorithm);
  hstate.add_wide_int (ptr->x_flag_ira_hoist_pressure);
  hstate.add_wide_int (ptr->x_flag_ira_loop_pressure);
  hstate.add_wide_int (ptr->x_flag_ira_region);
  hstate.add_wide_int (ptr->x_flag_ira_share_save_slots);
  hstate.add_wide_int (ptr->x_flag_ira_share_spill_slots);
  hstate.add_wide_int (ptr->x_flag_isolate_erroneous_paths_attribute);
  hstate.add_wide_int (ptr->x_flag_isolate_erroneous_paths_dereference);
  hstate.add_wide_int (ptr->x_flag_ivopts);
  hstate.add_wide_int (ptr->x_flag_jump_tables);
  hstate.add_wide_int (ptr->x_flag_lifetime_dse);
  hstate.add_wide_int (ptr->x_flag_live_range_shrinkage);
  hstate.add_wide_int (ptr->x_flag_loop_block);
  hstate.add_wide_int (ptr->x_flag_loop_interchange);
  hstate.add_wide_int (ptr->x_flag_loop_optimize_isl);
  hstate.add_wide_int (ptr->x_flag_loop_parallelize_all);
  hstate.add_wide_int (ptr->x_flag_loop_strip_mine);
  hstate.add_wide_int (ptr->x_flag_loop_unroll_jam);
  hstate.add_wide_int (ptr->x_flag_lra_remat);
  hstate.add_wide_int (ptr->x_flag_errno_math);
  hstate.add_wide_int (ptr->x_flag_modulo_sched);
  hstate.add_wide_int (ptr->x_flag_modulo_sched_allow_regmoves);
  hstate.add_wide_int (ptr->x_flag_move_loop_invariants);
  hstate.add_wide_int (ptr->x_flag_non_call_exceptions);
  hstate.add_wide_int (ptr->x_flag_nothrow_opt);
  hstate.add_wide_int (ptr->x_flag_omit_frame_pointer);
  hstate.add_wide_int (ptr->x_flag_opt_info);
  hstate.add_wide_int (ptr->x_flag_optimize_sibling_calls);
  hstate.add_wide_int (ptr->x_flag_optimize_strlen);
  hstate.add_wide_int (ptr->x_flag_pack_struct);
  hstate.add_wide_int (ptr->x_flag_partial_inlining);
  hstate.add_wide_int (ptr->x_flag_peel_loops);
  hstate.add_wide_int (ptr->x_flag_no_peephole);
  hstate.add_wide_int (ptr->x_flag_peephole2);
  hstate.add_wide_int (ptr->x_flag_predictive_commoning);
  hstate.add_wide_int (ptr->x_flag_prefetch_loop_arrays);
  hstate.add_wide_int (ptr->x_flag_reciprocal_math);
  hstate.add_wide_int (ptr->x_flag_pcc_struct_return);
  hstate.add_wide_int (ptr->x_flag_rename_registers);
  hstate.add_wide_int (ptr->x_flag_reorder_blocks);
  hstate.add_wide_int (ptr->x_flag_reorder_blocks_and_partition);
  hstate.add_wide_int (ptr->x_flag_reorder_functions);
  hstate.add_wide_int (ptr->x_flag_rerun_cse_after_loop);
  hstate.add_wide_int (ptr->x_flag_resched_modulo_sched);
  hstate.add_wide_int (ptr->x_flag_rounding_math);
  hstate.add_wide_int (ptr->x_flag_rtti);
  hstate.add_wide_int (ptr->x_flag_sched_critical_path_heuristic);
  hstate.add_wide_int (ptr->x_flag_sched_dep_count_heuristic);
  hstate.add_wide_int (ptr->x_flag_sched_group_heuristic);
  hstate.add_wide_int (ptr->x_flag_schedule_interblock);
  hstate.add_wide_int (ptr->x_flag_sched_last_insn_heuristic);
  hstate.add_wide_int (ptr->x_flag_sched_pressure);
  hstate.add_wide_int (ptr->x_flag_sched_rank_heuristic);
  hstate.add_wide_int (ptr->x_flag_schedule_speculative);
  hstate.add_wide_int (ptr->x_flag_sched_spec_insn_heuristic);
  hstate.add_wide_int (ptr->x_flag_schedule_speculative_load);
  hstate.add_wide_int (ptr->x_flag_schedule_speculative_load_dangerous);
  hstate.add_wide_int (ptr->x_flag_sched_stalled_insns);
  hstate.add_wide_int (ptr->x_flag_sched_stalled_insns_dep);
  hstate.add_wide_int (ptr->x_flag_sched2_use_superblocks);
  hstate.add_wide_int (ptr->x_flag_schedule_fusion);
  hstate.add_wide_int (ptr->x_flag_schedule_insns);
  hstate.add_wide_int (ptr->x_flag_schedule_insns_after_reload);
  hstate.add_wide_int (ptr->x_flag_section_anchors);
  hstate.add_wide_int (ptr->x_flag_sel_sched_pipelining);
  hstate.add_wide_int (ptr->x_flag_sel_sched_pipelining_outer_loops);
  hstate.add_wide_int (ptr->x_flag_sel_sched_reschedule_pipelined);
  hstate.add_wide_int (ptr->x_flag_selective_scheduling);
  hstate.add_wide_int (ptr->x_flag_selective_scheduling2);
  hstate.add_wide_int (ptr->x_flag_short_double);
  hstate.add_wide_int (ptr->x_flag_short_enums);
  hstate.add_wide_int (ptr->x_flag_short_wchar);
  hstate.add_wide_int (ptr->x_flag_shrink_wrap);
  hstate.add_wide_int (ptr->x_flag_signaling_nans);
  hstate.add_wide_int (ptr->x_flag_signed_zeros);
  hstate.add_wide_int (ptr->x_flag_simd_cost_model);
  hstate.add_wide_int (ptr->x_flag_single_precision_constant);
  hstate.add_wide_int (ptr->x_flag_split_ivs_in_unroller);
  hstate.add_wide_int (ptr->x_flag_split_wide_types);
  hstate.add_wide_int (ptr->x_flag_ssa_phiopt);
  hstate.add_wide_int (ptr->x_flag_stack_reuse);
  hstate.add_wide_int (ptr->x_flag_stdarg_opt);
  hstate.add_wide_int (ptr->x_flag_strict_aliasing);
  hstate.add_wide_int (ptr->x_flag_strict_enums);
  hstate.add_wide_int (ptr->x_flag_strict_overflow);
  hstate.add_wide_int (ptr->x_flag_strict_volatile_bitfields);
  hstate.add_wide_int (ptr->x_flag_thread_jumps);
  hstate.add_wide_int (ptr->x_flag_threadsafe_statics);
  hstate.add_wide_int (ptr->x_flag_tracer);
  hstate.add_wide_int (ptr->x_flag_trapping_math);
  hstate.add_wide_int (ptr->x_flag_trapv);
  hstate.add_wide_int (ptr->x_flag_tree_bit_ccp);
  hstate.add_wide_int (ptr->x_flag_tree_builtin_call_dce);
  hstate.add_wide_int (ptr->x_flag_tree_ccp);
  hstate.add_wide_int (ptr->x_flag_tree_ch);
  hstate.add_wide_int (ptr->x_flag_ssa_coalesce_vars);
  hstate.add_wide_int (ptr->x_flag_tree_copy_prop);
  hstate.add_wide_int (ptr->x_flag_tree_copyrename);
  hstate.add_wide_int (ptr->x_flag_tree_cselim);
  hstate.add_wide_int (ptr->x_flag_tree_dce);
  hstate.add_wide_int (ptr->x_flag_tree_dom);
  hstate.add_wide_int (ptr->x_flag_tree_dse);
  hstate.add_wide_int (ptr->x_flag_tree_forwprop);
  hstate.add_wide_int (ptr->x_flag_tree_fre);
  hstate.add_wide_int (ptr->x_flag_tree_loop_distribute_patterns);
  hstate.add_wide_int (ptr->x_flag_tree_loop_distribution);
  hstate.add_wide_int (ptr->x_flag_tree_loop_if_convert);
  hstate.add_wide_int (ptr->x_flag_tree_loop_if_convert_stores);
  hstate.add_wide_int (ptr->x_flag_tree_loop_im);
  hstate.add_wide_int (ptr->x_flag_tree_loop_ivcanon);
  hstate.add_wide_int (ptr->x_flag_tree_loop_optimize);
  hstate.add_wide_int (ptr->x_flag_tree_loop_vectorize);
  hstate.add_wide_int (ptr->x_flag_tree_live_range_split);
  hstate.add_wide_int (ptr->x_flag_tree_parallelize_loops);
  hstate.add_wide_int (ptr->x_flag_tree_partial_pre);
  hstate.add_wide_int (ptr->x_flag_tree_phiprop);
  hstate.add_wide_int (ptr->x_flag_tree_pre);
  hstate.add_wide_int (ptr->x_flag_tree_pta);
  hstate.add_wide_int (ptr->x_flag_tree_reassoc);
  hstate.add_wide_int (ptr->x_flag_tree_scev_cprop);
  hstate.add_wide_int (ptr->x_flag_tree_sink);
  hstate.add_wide_int (ptr->x_flag_tree_slp_vectorize);
  hstate.add_wide_int (ptr->x_flag_tree_slsr);
  hstate.add_wide_int (ptr->x_flag_tree_sra);
  hstate.add_wide_int (ptr->x_flag_tree_switch_conversion);
  hstate.add_wide_int (ptr->x_flag_tree_tail_merge);
  hstate.add_wide_int (ptr->x_flag_tree_ter);
  hstate.add_wide_int (ptr->x_flag_tree_vectorize);
  hstate.add_wide_int (ptr->x_flag_tree_vrp);
  hstate.add_wide_int (ptr->x_flag_unroll_all_loops);
  hstate.add_wide_int (ptr->x_flag_unroll_loops);
  hstate.add_wide_int (ptr->x_flag_unsafe_loop_optimizations);
  hstate.add_wide_int (ptr->x_flag_unsafe_math_optimizations);
  hstate.add_wide_int (ptr->x_flag_unswitch_loops);
  hstate.add_wide_int (ptr->x_flag_unwind_tables);
  hstate.add_wide_int (ptr->x_flag_var_tracking);
  hstate.add_wide_int (ptr->x_flag_var_tracking_assignments);
  hstate.add_wide_int (ptr->x_flag_var_tracking_assignments_toggle);
  hstate.add_wide_int (ptr->x_flag_var_tracking_uninit);
  hstate.add_wide_int (ptr->x_flag_variable_expansion_in_unroller);
  hstate.add_wide_int (ptr->x_flag_vect_cost_model);
  hstate.add_wide_int (ptr->x_flag_value_profile_transformations);
  hstate.add_wide_int (ptr->x_flag_web);
  hstate.add_wide_int (ptr->x_flag_wrapv);
  return hstate.end ();
}
                            ...
                            struct cl_optimization *ptr)
{
  ...
  bp_pack_value (bp, ptr->x_flag_ipa_cp_alignment, 64);
  ...
  bp_pack_value (bp, ptr->x_flag_loop_block, 64);
  bp_pack_value (bp, ptr->x_flag_loop_interchange, 64);
  bp_pack_value (bp, ptr->x_flag_loop_optimize_isl, 64);
  bp_pack_value (bp, ptr->x_flag_loop_parallelize_all, 64);
  bp_pack_value (bp, ptr->x_flag_loop_strip_mine, 64);
  bp_pack_value (bp, ptr->x_flag_loop_unroll_jam, 64);
  ...
  bp_pack_value (bp, ptr->x_flag_short_double, 64);
  ...
  bp_pack_value (bp, ptr->x_flag_strict_overflow, 64);
  ...
  bp_pack_value (bp, ptr->x_flag_ssa_coalesce_vars, 64);
  bp_pack_value (bp, ptr->x_flag_tree_copy_prop, 64);
  bp_pack_value (bp, ptr->x_flag_tree_copyrename, 64);
  ...
  bp_pack_value (bp, ptr->x_flag_tree_loop_if_convert_stores, 64);
  ...
  bp_pack_value (bp, ptr->x_flag_tree_vectorize, 64);
  ...
  bp_pack_value (bp, ptr->x_flag_unsafe_loop_optimizations, 64);
                           ...
                           struct cl_optimization *ptr)
{
  ...
  ptr->x_flag_ipa_cp_alignment = (signed char ) bp_unpack_value (bp, 64);
  ...
  ptr->x_flag_loop_block = (signed char ) bp_unpack_value (bp, 64);
  ptr->x_flag_loop_interchange = (signed char ) bp_unpack_value (bp, 64);
  ptr->x_flag_loop_optimize_isl = (signed char ) bp_unpack_value (bp, 64);
  ptr->x_flag_loop_parallelize_all = (signed char ) bp_unpack_value (bp, 64);
  ptr->x_flag_loop_strip_mine = (signed char ) bp_unpack_value (bp, 64);
  ptr->x_flag_loop_unroll_jam = (signed char ) bp_unpack_value (bp, 64);
  ...
  ptr->x_flag_short_double = (signed char ) bp_unpack_value (bp, 64);
  ...
  ptr->x_flag_strict_overflow = (signed char ) bp_unpack_value (bp, 64);
  ...
  ptr->x_flag_ssa_coalesce_vars = (signed char ) bp_unpack_value (bp, 64);
  ptr->x_flag_tree_copy_prop = (signed char ) bp_unpack_value (bp, 64);
  ptr->x_flag_tree_copyrename = (signed char ) bp_unpack_value (bp, 64);
  ...
  ptr->x_flag_tree_loop_if_convert_stores = (signed char ) bp_unpack_value (bp, 64);
  ...
  ptr->x_flag_tree_vectorize = (signed char ) bp_unpack_value (bp, 64);
  ...
  ptr->x_flag_unsafe_loop_optimizations = (signed char ) bp_unpack_value (bp, 64);
